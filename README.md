...
- <div align="justify"> eks: Create an <a href="https://aws.amazon.com/eks/">eks</a> cluster in aws where all the other tools are going to be installed on top of. </div>
